                ...
                try:
                    ...
                    if is_enabled():
                        ...
                        if self._ds_bwd_client is None:
                            rb = build_real_backward(self.model)  # in-process fallback
                            # §13: publish the trained LoRA into the inference forward
                            if os.environ.get("SGLANG_DS_PUBLISH_LORA", "0") == "1":
                                rb.attach_inference_hooks()
                except Exception as e:
